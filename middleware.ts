...
export async function middleware(req: NextRequest) {
  ...
  if (pathname === "/b2b/login" || pathname === "/factory/login" || pathname === "/api/b2b/auth" || pathname === "/api/voc/tally" || pathname === "/api/b2b/schedule-digest" || pathname === "/api/briefing/cron" || pathname === "/api/b2b/deposits/webhook" || pathname === "/api/instagram/webhook" || pathname === "/api/naver/catalog/sync" || pathname.startsWith("/q/")) {
