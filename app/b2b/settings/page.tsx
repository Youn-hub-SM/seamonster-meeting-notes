    ...
    <>
      ...
      <section className="b2b-card">
        <div className="b2b-card-head">
          ...
          {modelSaving && <span style={{ fontSize: 12, color: "var(--sm-text-light)" }}>적용 중...</span>}
        </div>
      ...
      <section className="b2b-card">
        <div className="b2b-card-head">
          ...
          {csModelSaving && <span style={{ fontSize: 12, color: "var(--sm-text-light)" }}>적용 중...</span>}
        </div>
        <p style={{ fontSize: 12, color: "var(--sm-text-mid)", margin: "0 0 14px" }}>
      ...
      <section className="b2b-card">
        <div className="b2b-card-head">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {csPromptSaved && <span style={{ fontSize: 12, color: "var(--sm-success)" }}>{csPromptSaved}</span>}
            <span style={{ fontSize: 11.5, color: csPromptIsDefault ? "var(--sm-text-light)" : "var(--sm-orange)" }}>
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 12, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 11.5, color: "var(--sm-text-light)" }}>
      ...
      <section className="b2b-card">
        <div className="b2b-card-head">
          ...
          <span style={{ fontSize: 11.5, color: sheetConnected ? "var(--sm-success)" : "var(--sm-text-light)" }}>
        ...
        {loading ? (
          ...
          <>
            <ol style={{ fontSize: 12.5, color: "var(--sm-text-mid)", lineHeight: 1.9, margin: "0 0 12px", paddingLeft: 20 }}>
            ...
            <div style={{ position: "relative", marginBottom: 14 }}>
              ...
              <button
                ...
                style={{ position: "absolute", top: 8, right: 8, padding: "4px 12px", fontSize: 11.5 }}
                onClick={() => {
            ...
            {sheetMsg && (
              <div style={{ fontSize: 12, color: sheetMsg.startsWith("✅") ? "var(--sm-success)" : "var(--sm-text-mid)", marginTop: 10 }}>
                {sheetMsg}
              </div>
            )}
          </>
