            ...
            <tbody>
              ...
              {Number(order.discount_amount) !== 0 && (
                <tr>
                  ...
                  <td colSpan={4}>{Number(order.discount_amount) > 0 ? "할인" : "추가금"}{order.discount_reason ? ` — ${order.discount_reason}` : ""}</td>
                  {Number(order.discount_amount) > 0 ? (
                    <td className="num b2b-money" style={{ color: "var(--sm-danger)" }}>-{won(Number(order.discount_amount) || 0)}</td>
                  ) : (
                    <td className="num b2b-money">+{won(-(Number(order.discount_amount) || 0))}</td>
                  )}
                  <td className="num">-</td>
                  <td />
                </tr>
