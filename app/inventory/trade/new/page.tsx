...
export default function NewTradePage() {
  ...
  const products = useMemo<PickProduct[]>(() => rows.map((r) => ({ id: r.product_id, name: r.name, sku: r.sku, spec: r.spec, unit: r.unit, cost_price: r.cost_price, purchase_price: r.purchase_price, origin: r.origin, attrs: r.attrs, qty: r.qty, is_bundle: r.is_bundle })), [rows]);
