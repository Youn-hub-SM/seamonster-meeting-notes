...
export async function POST(req: NextRequest) {
  try {
    ...
    for (const k of ["minSpend", "testDailyPerCreative", "testDays", "aboPassRoas", "aboMaxCpa", "aboMinPurchases", "scaleRoas", "scaleDays", "scalePct", "declineRoas", "libraryRoas"] as const) {
